...
public class Edge : IComparable<Edge> //Define un método de comparación generalizado específico del tipo que implementa un tipo o una clase de valor con el fin de ordenar sus instancias.
{
    public int vertexA;
    public int vertexB;
    public int vertexC;
